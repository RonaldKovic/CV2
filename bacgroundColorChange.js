...
var animation_end_pos = 300; //animation to stop
var beginning_color = new $.Color('rgb(255,255,255)');
var ending_color = new $.Color('rgb(0,0,1)');; //what color to use in the end
$(document).scroll(function () {
  ...
  if (scroll_pos >= animation_begin_pos && scroll_pos <= animation_end_pos) {
    ...
    var newGreen = beginning_color.green() + ((ending_color.green() - beginning_color.green()) *
      percentScrolled);
